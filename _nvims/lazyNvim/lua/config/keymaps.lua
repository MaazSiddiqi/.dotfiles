...
-- toggle options
map("n", "<leader>lf", require("lazyvim.plugins.lsp.format").toggle, { desc = "Toggle format on Save" })
...
--
-- lazygit
map("n", "<leader>G", function() Util.float_term({ "lazygit" }) end, { desc = "Open LazyGit"})
-- lazy
